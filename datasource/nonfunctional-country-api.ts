/**
 * Unused and untested class for calling external countries API (it uses features that require a subscription) 
 * Note that this behavior would be required for original project requirements
 */
